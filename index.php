...
$query = "SELECT * FROM kost INNER JOIN user ON kost.id_pemilik = user.id WHERE id_kost_saya = 1 LIMIT $awalData,$jumlah_data_perhalaman";
...
<body>
  <div class="container">
    <div class="container">
    <div class="row">
      <p><a href="login.php"><button class="btn btn-primary">Login/Daftar</button></a> Sekarang untuk mulai mencari kost
        atau iklankan kost</p>
            ...
            <div class="card-footer">
              <div class="row">
                ...
                <?php
                  ...
                  ?>
                <div class="col"
                  style="background-color:pink;font-size:12px;font-weight:bold;color:white;border-radius: 10px;">
                  <?php echo $d['jenis_kost'] ?></div>
                <?php
    ...
    <div class="row">
      ...
      <a style="font-weight: bold;background-color:black;padding:10px;color:white;"
        href="?halaman=<?php echo $i ?>"><?php echo $i ?></a>
      <?php else : ?>
      <a style="font-weight: bold;background-color:red;padding:10px;color:white"
        href="?halaman=<?php echo $i ?>"><?php echo $i ?></a>
      <?php endif; ?>
      <?php endfor; ?>
    </div>
