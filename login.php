      ...
      <div class="login-form">
        <form action="php/login_proses.php" method="post" class="bg-white">
          ...
          <div class="form-group">
            <input autocomplete="off" autofocus required="required" class="form-control text-center" type="text"
              name="username" id="username" placeholder="Masukan username">
          </div>
          <div class="form-group">
            <input autocomplete="off" autofocus required="required" type="password" name="password" id="password"
              class="form-control text-center" placeholder="Masukan Password">
          </div>
